...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="img/headset.png" type="image/png">
	       ...
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	            ...
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="http://www.facebook.com" target="_blank"><img src="./img/fb.png" alt="fb logo" style="width:40px; height:40px; border-right:0px; padding:1px; margin-right:20px"></a>
                   <a href="http://www.instagram.com" target="_blank"><img src="./img/instaicon.jpg" alt="instagram logo" style="width:40px; height:40px; border:0; padding:1px;margin-right:20px"></a>
<a href="http://www.twitter.com" target="_blank"><img src="./img/logotwitter.png" alt="instagram logo" style="width:40px; height:40px; border:0; padding:1px;"></a>
               </div>
            </div>
        </div>
    </div>
